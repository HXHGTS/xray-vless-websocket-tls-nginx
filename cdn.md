...
一个典型Clash配置:
```
  - {name: xxxxxxxxxx, server: 1.0.0.1, port: 2053, type: vless, uuid: xxxxxxxxx-xxxx-xxxx-xxxxxx, alterId: 0, cipher: auto, tls: true, network: ws, ws-path: /xxxxx, ws-headers: {Host: xxx.xxxxxx.workers.dev}}
```
